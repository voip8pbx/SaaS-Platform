...
"[project]/src/app/customize/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CustomizePage() {
    ...
    if ($[0] !== "9fa3aba232fbb87f83d06b87061aedbf673fe38323e42d30cc4559b2f2e752d8") {
        for(let $i = 0; $i < 103; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9fa3aba232fbb87f83d06b87061aedbf673fe38323e42d30cc4559b2f2e752d8";
    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(_CustomizePageUseEffect, t1);
    let t2;
    if ($[3] !== config.backgroundColor || $[4] !== config.headerColor || $[5] !== config.primaryColor || $[6] !== router) {
        t2 = ({
            "CustomizePage[handleSave]": async ()=>{
                setStatus("saving");
                ;
                try {
                    ...
                    setStatus("success");
                    setTimeout({
                        "CustomizePage[handleSave > setTimeout()]": ()=>{
                            router.push("/");
                        }
                    }["CustomizePage[handleSave > setTimeout()]"], 1000);
                } catch (t3) {
                    const error = t3;
                    console.error(error);
                    setStatus("idle");
        ...
        })["CustomizePage[handleSave]"];
        $[3] = config.backgroundColor;
        $[4] = config.headerColor;
        $[5] = config.primaryColor;
        $[6] = router;
        $[7] = t2;
    } else {
        t2 = $[7];
    ...
    const handleSave = t2;
    const t3 = "min-h-screen bg-slate-950 text-white p-8";
    const t4 = "max-w-4xl mx-auto";
    const t5 = "flex items-center justify-between mb-12";
    let t6;
    if ($[8] !== router) {
        t6 = ({
            "CustomizePage[<button>.onClick]": ()=>router.back()
        })["CustomizePage[<button>.onClick]"];
        $[8] = router;
        $[9] = t6;
    } else {
        t6 = $[9];
    ...
    const t10 = "text-3xl font-bold";
    const t11 = "Customize ";
    const t12 = feature ? feature.charAt(0).toUpperCase() + feature.slice(1) : "Theme";
    let t13;
    if ($[14] !== t12) {
    ...
    let t16;
    if ($[20] !== config.backgroundColor) {
        t16 = {
            backgroundColor: config.backgroundColor
        };
        $[20] = config.backgroundColor;
        $[21] = t16;
    } else {
        t16 = $[21];
    }
    let t17;
    if ($[22] !== config.headerColor) {
        t17 = {
            backgroundColor: config.headerColor
        };
        $[22] = config.headerColor;
        $[23] = t17;
    } else {
        t17 = $[23];
    }
    ...
    if ($[29] !== config.primaryColor) {
        ...
        $[29] = config.primaryColor;
        $[30] = t22;
    } else {
        t22 = $[30];
    }
    let t23;
    if ($[31] !== t16 || $[32] !== t20 || $[33] !== t22) {
    ...
    let t26;
    if ($[37] !== config || $[38] !== setConfig) {
        t26 = ({
            "CustomizePage[<input>.onChange]": (e)=>setConfig({
                    ...config,
                    headerColor: e.target.value
                })
        })["CustomizePage[<input>.onChange]"];
        $[37] = config;
        $[38] = setConfig;
        $[39] = t26;
    } else {
    ...
    let t27;
    if ($[40] !== config.headerColor || $[41] !== t26) {
    ...
    let t28;
    if ($[43] !== config || $[44] !== setConfig) {
        t28 = ({
            "CustomizePage[<input>.onChange]": (e_0)=>setConfig({
                    ...config,
                    headerColor: e_0.target.value
                })
        })["CustomizePage[<input>.onChange]"];
        $[43] = config;
        $[44] = setConfig;
    ...
    let t29;
    if ($[46] !== config.headerColor || $[47] !== t28) {
    ...
    let t32;
    if ($[53] !== config || $[54] !== setConfig) {
        t32 = ({
            "CustomizePage[<input>.onChange]": (e_1)=>setConfig({
                    ...config,
                    backgroundColor: e_1.target.value
                })
        })["CustomizePage[<input>.onChange]"];
        $[53] = config;
        $[54] = setConfig;
    ...
    let t33;
    if ($[56] !== config.backgroundColor || $[57] !== t32) {
    ...
    let t34;
    if ($[59] !== config || $[60] !== setConfig) {
        t34 = ({
            "CustomizePage[<input>.onChange]": (e_2)=>setConfig({
                    ...config,
                    backgroundColor: e_2.target.value
                })
        })["CustomizePage[<input>.onChange]"];
        $[59] = config;
        $[60] = setConfig;
    ...
    let t35;
    if ($[62] !== config.backgroundColor || $[63] !== t34) {
    ...
    let t38;
    if ($[69] !== config || $[70] !== setConfig) {
        t38 = ({
            "CustomizePage[<input>.onChange]": (e_3)=>setConfig({
                    ...config,
    ...
    let t39;
    if ($[72] !== config.primaryColor || $[73] !== t38) {
    ...
    let t40;
    if ($[75] !== config || $[76] !== setConfig) {
        t40 = ({
            "CustomizePage[<input>.onChange]": (e_4)=>setConfig({
                    ...config,
    ...
    let t41;
    if ($[78] !== config.primaryColor || $[79] !== t40) {
    ...
    const t44 = status === "saving";
    let t45;
    if ($[88] !== status) {
        t45 = status === "saving" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    let t46;
    if ($[90] !== handleSave || $[91] !== t44 || $[92] !== t45) {
...
_s(CustomizePage, "43fIwFmvhwBjSwAlE7eNa0rlGDo=", false, function() {
    return [
...
_c = CustomizePage;
function _CustomizePageUseEffect() {}
var _c;
...
//# sourceMappingURL=_6922d75b._.js.map