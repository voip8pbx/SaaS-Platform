...
"[project]/src/app/api/superadmin/assign/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const admin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            adminId
        }, {
            $set: {
                features,
...
async function GET(req) {
    try {
        ...
        const fetchedAdminsList = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({});
        console.log(`[Assign API] Found ${fetchedAdminsList.length} admins.`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: fetchedAdminsList
        });
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__897563e9._.js.map